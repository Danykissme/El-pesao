...
let q = '128kbps'
let txt = `*᥀🎧୭ *Y U T U B E - P L A Y* ᥀🎧୭\n\n`
...
if (size.split('MB')[0] >= limit) return conn.reply(m.chat,`El archivo pesa mas de ${limit} MB, se canceló la Descarga.`, m, rcanal).then(_ => m.react('❌'))
